    ...
    <div>
      ...
      <div className="md:grid md:grid-cols-2 gap-10 mx-10 md:mx-40 mb-40">
        <Card
          ...
          title="AI-Powered Mock Interviews with"
          title2="InterviewD"
          textColor="#562ea3"
        ...
        <Card
          ...
          title="Dynamic Playlists Powered by"
          shadowTo="#a855f7"
          shadowFrom="#a855f7"
          image="/images/projects/auroraplay.png"
          title2="Weather & Spotify"
          textColor="#64319e"
          gradientEnd="#64319e"
        ...
        <Card
          ...
          title="Streamlined Digital Presence for"
          shadowTo="#123d95"
          shadowFrom="#123d95"
        ...
        <Card
          ...
          title="From Resume to Website in"
          shadowTo="#035476"
          shadowFrom="#a63f1a"
        ...
        <Card
          ...
          title="Share, Organize & Discover. All in your"
          shadowTo="#035476"
          shadowFrom="#a63f1a"
          image="/images/projects/es.png"
          title2="Essential Space "
          textColor="#52B9C8"
          gradientEnd="#52B9C8"
          gradientStart="#035476"
        ...
        <Card
          ...
          title="Create & Curate AI Art with"
          shadowTo="#a63f1a"
          shadowFrom="#a63f1a"
        ...
        <Card
          ...
          title="Life-Saving Connections, Powered by"
          shadowTo="#7b2222"
          shadowFrom="#7b2222"
