...
function FeaturedPage() {
  ...
  <div className="md:grid md:grid-cols-2 gap-10 mx-10 md:mx-40">
    ...
    <Card size="lg" title="From Resume to Website in" shadowTo="#035476" shadowFrom="#a63f1a" image='/images/projects/showfolio.png'  title2='One Click' textColor='#52B9C8'  gradientEnd='#1E2233' gradientStart='#035476' content='Showfolio simplifies personal branding by converting resumes into stylish, responsive portfolio sites built for professionals.' />
